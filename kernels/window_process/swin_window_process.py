...
# Fallback implementation using pure PyTorch
...
class MockSwinWindowProcess:
    roll_and_window_partition_forward = staticmethod(roll_and_window_partition_forward)
    roll_and_window_partition_backward = staticmethod(roll_and_window_partition_backward)
    window_merge_and_roll_forward = staticmethod(window_merge_and_roll_forward)
    window_merge_and_roll_backward = staticmethod(window_merge_and_roll_backward)

# Use the fallback implementation
swin_window_process = MockSwinWindowProcess()
